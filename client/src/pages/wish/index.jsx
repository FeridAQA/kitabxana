...
function Wishlist() {
    const { wishlist, toggleWishlist, clearWishlist } = useAppContext();
        ...
        <div className="mb-10 bg-white text-black">
            <div className="container mx-auto px-4 py-6 bg-opacity-90 rounded-lg shadow-lg">
                <div className="flex items-center">
                    <i className="fas fa-heart text-black text-3xl mr-2"></i>
                    <h2 className="text-2xl font-bold text-black mb-4">Wishlist</h2>
                </div>
                <div className="border-t-4 border-black mt-2"></div>
            </div>
            <div className="container mx-auto px-28 mt-6">
                {wishlist.length === 0 ? (
                    <p>Sizin wishlist boşdur.</p>
                ) : (
                    <div>
