...
function H_Best() {
    ...
    return (
        <div id='H_Best' className="bg-gradient-to-r from-purple-500 to-pink-600 pb-5">
            <div className="container mx-auto px-4 py-6 bg-opacity-90 rounded-lg shadow-lg">
                <div className="flex items-center">
                    <i className="fas fa-trophy text-white text-3xl mr-2"></i>
                    <h2 className="text-3xl font-bold text-white">Ən Çox Satan</h2>
                </div>
                                ...
                                <div className="card bg-white shadow-xl min-w-[280px] max-w-[280px] min-h-[430px] max-h-[430px] flex flex-col group rounded-lg">
                                    ...
                                    <div className="card-body flex flex-col justify-between p-4 bg-gray-100 rounded-b-lg flex-1">
                                        ...
                                        <div className="price-and-sold mb-2 flex justify-between items-center">
                                            ...
                                            <p className="font-semibold text-green-700 bg-green-100 px-2 py-1 rounded truncate">
                                                totalSold: {book.totalSold ? book.totalSold : 'No totalSold'}
                                            </p>
                                        </div>
